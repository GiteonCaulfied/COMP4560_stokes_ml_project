...
class Encoder(nn.Module):
    def __init__(self):
        ...
        self.encoder = nn.Sequential( # 201x401 => 
            nn.Conv2d(1, 3, stride=(2, 2), kernel_size=(5, 5), padding=2),
            nn.Tanh(),
            nn.Conv2d(3, 6, stride=(2, 2), kernel_size=(5, 5), padding=2),
            nn.Tanh(),
            nn.Conv2d(6, 9, stride=(2, 2), kernel_size=(5, 5), padding=2),
            nn.Tanh(),
        )
        '''
...
class Decoder(nn.Module):
    def __init__(self):
        ...
        self.decoder = nn.Sequential( # 201x401 => 
            nn.ConvTranspose2d(9, 6, stride=(2, 2), kernel_size=(5, 5), padding=(2,2)),
            nn.Tanh(),
            
            nn.ConvTranspose2d(6, 3, stride=(2, 2), kernel_size=(5, 5), padding=(2,2)),
            nn.Tanh(),
        
            nn.ConvTranspose2d(3, 1, stride=(2, 2), kernel_size=(5, 5), padding=(2,2)),
...
def train(model, encoder, train_loader, val_loader, device, optimizer, n_epoch):
    ...
    text_file = open('FNN_trainingData_Gadi.txt', "w")
    ...
    text_file.close()
    print("Training Data saved! The path is FNN_trainingData_Gadi.txt")
