...
Figure \ref{figure:FNN_limited_best_POD} and \ref{figure:FNN_limited_worst_POD} show the POD coefficients when applied to the best and worst case predictions, respectively.
