...
\begin{itemize}
     \item Research shows that when geoid is modelled purely based on density variation near the surface, the result can poorly explain the observed geoid measurements. [2]
...
[2] 1989. Long-wavelength variations in earth’s geoid: physical models and dynamical implications. Philosophical Transactions of the Royal Society of London. Series A, Mathematical and Physical Sciences, 328, 1599 (jul 1989), 309–327. doi:10.1098/rsta.1989.0038.

[3] Badia, S.; Li, W.; and n, . A. F. M., 2023. Finite element interpolated neural networks for solving forward and inverse problems. doi:10.1016/j.cma.2023.116505.