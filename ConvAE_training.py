...
def train(encoder, decoder, train_loader, val_loader, device, optimizer, n_epoch):
    ...
    for epoch in range(n_epoch):
        ...
        if valid_loss <= minimum_validation_loss:
            ...
            PATH1 = 'Conv2D_encoder_best_Gadi.pth'
            PATH2 = 'Conv2D_decoder_best_Gadi.pth'
    ...
    text_file = open('ConvAE_trainingData_Gadi.txt', "w")
    ...
    text_file.close()
    print("Training Data saved! The path is ConvAE_trainingData_Gadi.txt")
